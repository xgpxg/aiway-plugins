...
| **bailian**         | [x86_64](https://package-release.coderbox.cn/aiway/plugins/bailian-mi/0.1.0/x86_64/libbailian_mi.so)  /  [aarch64](https://package-release.coderbox.cn/aiway/plugins/bailian-mi/0.1.0/aarch64/libbailian_mi.so)                     | 0.1.0 | 模型输入      | 阿里百炼平台模型接口请求适配（文生图）                                     |
